...
function ContactMe({}: Props) {
    ...
    return (
        <section id="contact">
            ...
            >
                <h3
                    className="absolute top-20 tracking-[20px] text-gray-400 text-2xl uppercase"
                    onClick={() =>
                        console.log(
                            'contact clicked'
                        )
                ...
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap mt-24 items-center">
                    <div
                        className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end 
                    justify-center relative md:h-96"
                    >
                        <iframe
                            width="100%"
                            height="100%"
                        ...
                        ></iframe>
                        <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md left-1/2 -translate-x-1/2">
